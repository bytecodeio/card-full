...
export const DashboardVisualizations221 = ({visList,setSelectedFields,setSelectedInnerTab,selectedInnerTab,setVisList,handleSingleVisUpdate}) => {
    return(
        <>
        <Container className='grid dashboard-grid-layout-221' style={{minHeight:'1500px', maxWidth:'95%'}}>
            
            <div className="mb-3 dashboard-grid-right" style={{paddingTop:'10px'}}>
